...
/// <summary>
/// 调用回调函数audio_callback
/// </summary>
/// <param name="audio"></param>
/// <param name="audio_time"></param>
/// <param name="prev_time"></param>
...
#ifdef _WIN32
	DWORD unused = 0;
	const HANDLE handle = AvSetMmThreadCharacteristics(L"Audio", &unused);// Core Audio APIs 需要
#endif
...
int audio_output_open(audio_t **audio, struct audio_output_info *info)
{
	...
	out->input_param = info->input_param;// 音频回调函数参数
