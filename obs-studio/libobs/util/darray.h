...
/// <summary>
/// 根据capacity重新设置数组大小，小于原始容量不设置
/// </summary>
/// <param name="element_size">元素大小</param>
/// <param name="dst">数组指针</param>
/// <param name="capacity">可容纳元素个数</param>
...
/// <summary>
/// 确定数组可以容纳new_size个元素，不够将容量翻倍
/// </summary>
/// <param name="element_size">元素大小</param>
/// <param name="dst">数组指针</param>
/// <param name="new_size">新元素个数</param>
...
/// <summary>
/// 根据size重新设置数组大小，size为0或者与原始容量大小相等不设置。重新设置容量后，扩充部分以0填充
/// </summary>
/// <param name="element_size">元素大小</param>
/// <param name="dst">数组指针</param>
...
/// <summary>
/// 从源数组中拷贝指定的元素个数到目标数组并重新设置目标数组大小
/// </summary>
/// <param name="element_size">元素大小</param>
/// <param name="dst">目标数组</param>
/// <param name="array">源数组</param>
/// <param name="num">拷贝元素个数</param>
...
/// </summary>
/// <param name="element_size">元素大小</param>
/// <param name="da">数组指针</param>
/// <param name="item">元素指针</param>
/// <param name="idx">数组起始下标值</param>
/// <returns>查找的元素下标值</returns>
...
/// <summary>
/// 数组尾部加入一个新元素，数组容量不够以2倍扩充
/// </summary>
/// <param name="element_size">元素大小</param>
/// <param name="dst">数组指针</param>
/// <param name="item">元素指针</param>
/// <returns>加入的元素下标值</returns>
...
/// <summary>
/// 数组尾部加入一个空元素，数组容量不够以2倍扩充
/// </summary>
/// <param name="element_size">元素大小</param>
/// <param name="dst">数组指针</param>
/// <returns>空元素指针</returns>
...
/// <summary>
/// 数组尾部加入多个元素，数组容量不够以2倍扩充
/// </summary>
/// <param name="element_size">元素大小</param>
/// <param name="dst">数组指针</param>
/// <param name="array">多个元素指针</param>
/// <param name="num">元素数量</param>
/// <returns>加入之前的数组大小</returns>
