...
/// <summary>
/// 对静态变量obs_signals中的事件函数的解析和保存工作
/// </summary>
/// <param name=""></param>
/// <returns></returns>
...
/// <summary>
/// 初始化obs->hotkeys，映射自定义按键，开启按键检索线程（25ms检索一次）
/// </summary>
/// <param name=""></param>
/// <returns></returns>
...
/// <param name="module_config_path"></param>
...
bool obs_reset_audio2(const struct obs_audio_info2 *oai)
{
	...
	if (oai->max_buffering_ms) {
		...
		audio->max_buffering_ticks = 45;// 保存的最大帧数
	}
