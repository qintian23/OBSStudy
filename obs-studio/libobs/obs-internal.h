...
/// <summary>
/// obs自定义按键值初始化，window虚拟按键对应上obs自定义按键值
/// </summary>
...
struct obs_core_audio {
	audio_t *audio;
	/// <summary>
	/// 所有可用于渲染的源，包含系统自带源，自建设备采集源，自建场景源
	/// </summary>
	DARRAY(struct obs_source *) render_order;
	/// <summary>
	/// 系统自带的源（包含麦克风输出，桌面音频读取，场景源）
	/// </summary>
...
/// </summary>
/// <param name="param"></param>
/// <param name="start_ts_in">获取当前帧的开始时间</param>
/// <param name="end_ts_in">获取当前帧的结束时间</param>
/// <param name="out_ts">输出当前帧的时间戳</param>
/// <param name="mixers">录制或者推流混合输出</param>
/// <param name="mixes">输出音频采集数据</param>
/// <returns></returns>
...
/// <param name="mixers">混合数量</param>
/// <param name="channels">音频通道</param>
/// <param name="sample_rate">音频采样率</param>
/// <param name="size">音频输出帧大小</param>
