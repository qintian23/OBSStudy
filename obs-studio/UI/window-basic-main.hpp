...
private:
	...
	/// <summary>
	/// C:\Users\huangjk\AppData\Roaming\obs-studio\basic\profiles\test\basic.ini
	/// </summary>
...
private:
	...
	/// <summary>
	///  设置scenesToolbar和sourcesToolbar内的子控件属性themeID
	/// </summary>
...
private slots:
	...
	/// <summary>
	/// 场景重命名进行时事件（移除重命名按钮，修改Item名称）
	/// </summary>
	void EditSceneName();
	void EditSceneItemName();
	/// <summary>
	/// 场景重命名完成后事件（添加重命名按钮，加入撤销和重做队列）
	/// </summary>
	/// <param name="editor"></param>
	/// <param name="endHint"></param>
